SSH PROJECT LEARNING HOW TO CONNECT TO A REMOTE SERVER USING SSH ONLY.
GENERATING SSH KEYS,AUTHENTICATING CLIENTS,ADDING EXTRA RSA KEYS TO THE EXISTING ONES,
SETTING SSH ONLY AS THE MODE OF CONNECTING TO THER SERVER.
